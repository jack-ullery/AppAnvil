...
void ProcessAdapterTest::check_process_entry(ProcessTableEntry entry, const std::string &process_name, const std::string &profile_name, const unsigned int &pid)
{
