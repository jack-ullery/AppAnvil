...
template class BlockingQueue<ConsoleThread<ProfilesController<Profiles, StatusColumnRecord, Database, ProfileAdapter<Database>>, ProcessesController<Processes, StatusColumnRecord, Database, ProcessAdapter<Database>>, LogsController<Logs, Database, LogAdapter<Database> > >::Message, std::deque<ConsoleThread<ProfilesController<Profiles, StatusColumnRecord, Database, ProfileAdapter<Database>>, ProcessesController<Processes, StatusColumnRecord, Database, ProcessAdapter<Database>>, LogsController<Logs, Database, LogAdapter<Database> > >::Message, std::allocator<ConsoleThread<ProfilesController<Profiles, StatusColumnRecord, Database, ProfileAdapter<Database>>, ProcessesController<Processes, StatusColumnRecord, Database, ProcessAdapter<Database>>, LogsController<Logs, Database, LogAdapter<Database> > >::Message>>, std::mutex>;
