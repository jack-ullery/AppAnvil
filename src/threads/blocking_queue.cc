...
template class BlockingQueue<ConsoleThread<ProfilesController<Profiles, Database, ProfileAdapter<Database>>, ProcessesController<Processes, Database, ProcessAdapter<Database, StatusColumnRecord>>, LogsController<Logs, Database, LogAdapter<Database, StatusColumnRecord> > >::Message, std::deque<ConsoleThread<ProfilesController<Profiles, Database, ProfileAdapter<Database>>, ProcessesController<Processes, Database, ProcessAdapter<Database, StatusColumnRecord>>, LogsController<Logs, Database, LogAdapter<Database, StatusColumnRecord> > >::Message, std::allocator<ConsoleThread<ProfilesController<Profiles, Database, ProfileAdapter<Database>>, ProcessesController<Processes, Database, ProcessAdapter<Database, StatusColumnRecord>>, LogsController<Logs, Database, LogAdapter<Database, StatusColumnRecord> > >::Message>>, std::mutex>;
template class BlockingQueue<DispatcherMiddleman<ProfilesController<Profiles, Database, ProfileAdapter<Database>>, ProcessesController<Processes, Database, ProcessAdapter<Database, StatusColumnRecord>>, LogsController<Logs, Database, LogAdapter<Database, StatusColumnRecord> >, Glib::Dispatcher, std::mutex>::CallData, std::deque<DispatcherMiddleman<ProfilesController<Profiles, Database, ProfileAdapter<Database>>, ProcessesController<Processes, Database, ProcessAdapter<Database, StatusColumnRecord>>, LogsController<Logs, Database, LogAdapter<Database, StatusColumnRecord> >, Glib::Dispatcher, std::mutex>::CallData, std::allocator<DispatcherMiddleman<ProfilesController<Profiles, Database, ProfileAdapter<Database>>, ProcessesController<Processes, Database, ProcessAdapter<Database, StatusColumnRecord>>, LogsController<Logs, Database, LogAdapter<Database, StatusColumnRecord> >, Glib::Dispatcher, std::mutex>::CallData> >, std::mutex>;