...
template class DispatcherMiddleman<ProfilesController<Profiles, StatusColumnRecord, Database, ProfileAdapter<Database>>, ProcessesController<Processes, StatusColumnRecord, Database, ProcessAdapter<Database>>, LogsController<Logs, StatusColumnRecord>, Glib::Dispatcher, std::mutex>;