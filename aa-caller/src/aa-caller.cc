...
AppArmorCaller::results
AppArmorCaller::call_command(const std::vector<std::string> &command)
{
  results result;
...
std::string
AppArmorCaller::call_command(const std::vector<std::string> &command, const std::string &return_on_error)
{
  if (command.empty()) {
...
std::string
AppArmorCaller::get_status(AppArmorCaller *caller)
{
...
std::string
AppArmorCaller::get_unconfined(AppArmorCaller *caller)
{
